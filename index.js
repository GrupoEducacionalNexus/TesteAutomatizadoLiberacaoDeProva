...
(async () => {
    ...
    if (opcaoCursos) {
        ...
        if (opcaoGestaoDeCursos) {
            ...
            page.waitForSelector('body > div.page-container.row-fluid > div.page-content > div > div:nth-child(11) > table > tbody > tr:nth-child(37) > td:nth-child(11) > div > img');
            await new Promise((resolve) => setTimeout(resolve, 3000)); // Aguarda 3 segundos antes de acessar o próximo elemento
            const btnAtualizar = await page.$('body > div.page-container.row-fluid > div.page-content > div > div:nth-child(11) > table > tbody > tr:nth-child(37) > td:nth-child(11) > div > img'); //pegar referencia do curso
            ...
            if (btnAtualizar) {
                ...
                await page.goto('https://cbi.sistemasiga.net/curso/atualizar/33', { waitUntil: ['load', 'networkidle0'] });
                console.log('Página atual:', page.url());
                ...
                if (btnEad) {
                    ...
                    if (btnAulas) {
                        ...
                        const btn1Ano= await page.$('#tab_3_6_2 > div > ul > li:nth-child(3) > a');
                        if (btn1Ano) {
                            btn1Ano.click();
                            ...
                            const arrayCheckbox = await page.$$(`.check26`);
