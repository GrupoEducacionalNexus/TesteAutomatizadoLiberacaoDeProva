...
(async () => {
    ...
    if (opcaoCursos) {
        ...
        if (opcaoGestaoDeCursos) {
            ...
            //Vai abrir a pagina inicial dos cursos
            //fixo


            page.waitForSelector('body > div.page-container.row-fluid > div.page-content > div > div:nth-child(11) > table > tbody > tr:nth-child(57) > td:nth-child(11) > div > img');
            await new Promise((resolve) => setTimeout(resolve, 3000)); // Aguarda 3 segundos antes de acessar o próximo elemento
            const btnAtualizar = await page.$('body > div.page-container.row-fluid > div.page-content > div > div:nth-child(11) > table > tbody > tr:nth-child(57) > td:nth-child(11) > div > img'); //pegar referencia do curso
            ...
            if (btnAtualizar) {
                ...
                await page.goto('https://cbi.sistemasiga.net/curso/atualizar/41', { waitUntil: ['load', 'networkidle0'] });
                console.log('Página atual:', page.url());
                ...
                if (btnEad) {
                    ...
                    if (btnAulas) {
                        ...
                        const btn3anoComClassificacao= await page.$('#tab_3_6_2 > div > ul > li:nth-child(2) > a');
                        if (btn3anoComClassificacao) {
                            btn3anoComClassificacao.click();
                            ...
                            const arrayDeAulas = await page.$$("#tab_3_6_2_2 > div:nth-child(20) > table > tbody > tr");
                            ...
                            const arrayCheckbox = await page.$$(`.check37`);
